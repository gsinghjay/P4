<?php include 'includes/header.php'; ?>
 ...
 <div class="p-5 mb-4 bg-dark text-white">
  <div class="container-fluid py-5">
    <h1 class="display-5 fw-bold">Welcome to J&K Sea Moss</h1>
    <p class="col-md-8 fs-4">Discover the health benefits of sea moss from our premium range of products.</p>
